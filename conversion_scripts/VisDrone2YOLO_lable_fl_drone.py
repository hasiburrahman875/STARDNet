...
split = "val"
YOLO_LABELS_PATH = f"/cluster/pixstor/madrias-lab/Hasibur/STARDNet/Datasets/fl_drones/{split}/yolo_labels"
VISANN_PATH = f"/cluster/pixstor/madrias-lab/Hasibur/STARDNet/Datasets/fl_drones/{split}/labels"
VISIMG_PATH = f"/cluster/pixstor/madrias-lab/Hasibur/STARDNet/Datasets/fl_drones/{split}/frames"
